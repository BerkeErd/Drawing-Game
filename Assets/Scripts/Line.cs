...
public class Line
{
    ...
    public void Draw()
    {
        GameObject newLineRenderer = GameObject.Instantiate(CanvasDrawer.staticLinePrefab, Vector3.zero, Quaternion.identity);
        LineRenderer lineRenderer = newLineRenderer.GetComponent<LineRenderer>();
        CanvasDrawer.drawnLineRenderers.Add(lineRenderer);
